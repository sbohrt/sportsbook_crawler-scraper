...
def scrape_single_game(browser_config, URL, market, THREE_POINTERS_OU_QUERY):
    """
    ...
    Args:
        ...
        market: Market name
        THREE_POINTERS_OU_QUERY: AgentQL query
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            data = page.query_data(THREE_POINTERS_OU_QUERY)
            selections = data.get("three_pointers_ou", [])
...
def main():
    ...
    filtered_links = [url + "?currency=cash&subType=player_total_3_pointers_made_milestones" for url in filtered_links]
    ...
    market_match = re.search(r'(\w+)\[\]', THREE_POINTERS_OU_QUERY)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {
            executor.submit(scrape_single_game, browser_config, URL, market, THREE_POINTERS_OU_QUERY): URL 
