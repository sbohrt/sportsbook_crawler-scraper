...
def scrape_single_game(browser_config, URL, market, POINTS_REBOUNDS_OU_QUERY):
    """
    ...
    Args:
        ...
        market: Market name
        POINTS_REBOUNDS_OU_QUERY: AgentQL query
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            data = page.query_data(POINTS_REBOUNDS_OU_QUERY)
            selections = data.get("points_rebounds_ou", [])
...
def main():
    ...
    filtered_links = [url + "?currency=cash&subType=player_total_points_rebounds" for url in filtered_links]
    ...
    market_match = re.search(r'(\w+)\[\]', POINTS_REBOUNDS_OU_QUERY)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {
            executor.submit(scrape_single_game, browser_config, URL, market, POINTS_REBOUNDS_OU_QUERY): URL 
