...
def scrape_single_game(browser_config, URL, market, ASSISTS_OU_QUERY):
    """
    ...
    Args:
        ...
        market: Market name
        ASSISTS_OU_QUERY: AgentQL query
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            data = page.query_data(ASSISTS_OU_QUERY)
            selections = data.get("assists_ou", [])
...
def main():
    ...
    filtered_links = [url + "?currency=cash&subType=player_total_assists_milestones" for url in filtered_links]
    ...
    market_match = re.search(r'(\w+)\[\]', ASSISTS_OU_QUERY)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {
            executor.submit(scrape_single_game, browser_config, URL, market, ASSISTS_OU_QUERY): URL 
