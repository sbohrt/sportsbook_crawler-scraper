...
def scrape_single_game(browser_config, URL, market, REBOUNDS_ASSISTS_OU_QUERY):
    """
    ...
    Args:
        ...
        market: Market name
        REBOUNDS_ASSISTS_OU_QUERY: AgentQL query
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            data = page.query_data(REBOUNDS_ASSISTS_OU_QUERY)
            selections = data.get("rebounds_assists_ou", [])
...
def main():
    ...
    filtered_links = [url + "?currency=cash&subType=player_total_rebounds_assists" for url in filtered_links]
    ...
    market_match = re.search(r'(\w+)\[\]', REBOUNDS_ASSISTS_OU_QUERY)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {
            executor.submit(scrape_single_game, browser_config, URL, market, REBOUNDS_ASSISTS_OU_QUERY): URL 
