...
def scrape_single_game(browser_config, URL, market, POINTS_ASSISTS_QUERY):
    """
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.locator("button").filter(has_text="Player points + assists").click()
            ...
            data = page.query_data(POINTS_ASSISTS_QUERY)
            selections = data.get("points_assists", [])
...
def main():
    ...
    market_match = re.search(r'(\w+)\[\]', POINTS_ASSISTS_QUERY)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {
            executor.submit(scrape_single_game, browser_config, URL, market, POINTS_ASSISTS_QUERY): URL 
